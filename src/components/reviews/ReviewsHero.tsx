  ...
  return (
    <section className="relative min-h-screen bg-gearup-dark flex items-center overflow-hidden pt-16">
      <div className="absolute inset-0 z-0">
        <img 
          src="https://images.unsplash.com/photo-1434494878577-86c23bcb06b9?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80" 
          alt="Premium fitness equipment and smartwatch reviews setup" 
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
            Expert Fitness
            <span className="text-gearup-red block mt-2">Gear Reviews</span>
          </h1>
          
          <p className="text-xl sm:text-2xl text-gray-100 mb-8 max-w-3xl mx-auto">
            Get honest, detailed reviews of the latest fitness equipment, supplements, 
            and gear to make informed decisions for your fitness journey.
          </p>
